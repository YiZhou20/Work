function ym = metrics1App(nid1, cid1, run_id1, nid2, cid2, run_id2, startDate, endDate,...
    lidsStr, dataTypeOption, username, password)
% wrapper similar to plotDiff that call metrics1
...
if strcmp(dataTypeOption, 'velocity')
    [links1, d1, ~, times1, link_lengths1] = readLDT(nid1, cid1, run_id1, startDate, endDate, lids, dataTypeOption, username, password);
    [links2, d2, ~, times2, link_lengths2] = readLDT(nid2, cid2, run_id2, startDate, endDate, lids, dataTypeOption, username, password);
else
    [links1, ~, d1, times1, link_lengths1] = readLDT(nid1, cid1, run_id1, startDate, endDate, lids, dataTypeOption, username, password);
    [links2, ~, d2, times2, link_lengths2] = readLDT(nid2, cid2, run_id2, startDate, endDate, lids, dataTypeOption, username, password);
end
...
ym = metrics1(run_id1,run_id2,reshapedMatrix1,reshapedMatrix2,fineSpace1,dataTypeOption);
