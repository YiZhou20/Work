function [] = plotLinkOutflows(outflowMatrix, fineSpace, timeValues, ...
    startDate, endDate, run_id, max_flow)
...
imagesc(outflowMatrix);
set(gcf,'units','normalized','outerposition',[0 0 1 1]);
set(gca,'cLim',[0,max_flow]);
set(gcf,'Colormap',cmap);

title(sprintf('Outflows (veh/hr/lane) for Run ID %d', run_id), 'FontSize', 24);
...
x_ticks = 1:xStep:size(outflowMatrix,2);
